...
const RECIPE_PRESETS: Partial<Record<RecipeId, RecipePreset>> = {
  ...
  compact_card: {
    ...
    appearance: { thumb: { shape: 'rounded' }, title: { weight: 'bold' }, subtitle: { size: 'sm', textColor: 'muted' }, badge: { display: 'badge' } },
  },
  compact_avatar: {
    build: (has) => mediaRow('avatar', ['title', 'subtitle'], 'meta', has),
    appearance: { avatar: { shape: 'circle' }, title: { weight: 'bold' }, subtitle: { size: 'sm', textColor: 'muted' }, meta: { size: 'sm', textColor: 'muted' } },
  },
  row_text: {
    build: (has) => {
    ...
    appearance: { title: { weight: 'semibold' }, subtitle: { size: 'sm', textColor: 'muted', align: 'right' } },
  },
  ...
  hero_protagonico: {
    ...
    appearance: {
      ...
      title: { weight: 'bold', size: 'lg', align: 'center' }, subtitle: { size: 'sm', textColor: 'muted', align: 'center' },
      body: { size: 'sm' },
    },
  },
  editorial: {
    build: (has) => stack(['cover', 'title', 'meta', 'body', 'gallery'], has, { gap: 'md' }),
    appearance: { cover: { aspect: '16:9' }, title: { weight: 'bold', size: 'lg' }, meta: { size: 'sm', textColor: 'muted' }, body: { size: 'sm' } },
  },
  momento: {
    ...
    appearance: {
      ...
      title: { weight: 'bold', align: 'center' }, subtitle: { size: 'sm', textColor: 'muted', align: 'center' }, body: { size: 'sm' },
    },
  },
